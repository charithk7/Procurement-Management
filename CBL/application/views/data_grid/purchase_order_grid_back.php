        ...
        <div class="modal-content">
            <div class="modal-header">
               ...
               <!-- <button ng-repeat="i in getNumber(total_pages) track by $index" style="margin-right: 5px;"
                ...
                <div ng-show="total_months>1" class="dropdown pull-right" style="margin-right: 5px;">
                    <button  title="Months" class="btn btn-flat btn-default dropdown-toggle"  type="button" id="dropdownMenu3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        <i class="fa fa-calendar"></i> {{month_display_data}}
                        <span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu3">

                        <li><a ng-click="month_display_data='All';info_popup(contract_bill_id);" href="">All</a></li>
                        <li ng-repeat="i in months_details track by $index"><a  ng-click="change_month_display(i.month_name,i.month_start_date);" href="">{{i.month_name}}</a></li>
                ...
                <div ng-show="total_pages>1" class="dropdown pull-right" style="margin-right: 5px;">
                    <button  title="Bill" class="btn btn-flat btn-default dropdown-toggle"  type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        <i class="fa fa-file-text-o"></i> {{pagination_display_data}}
                        <span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">

                        <li><a ng-click="pagination_display_data='All';info_popup(contract_bill_id);" href="">All</a></li>
                        <li ng-repeat="i in getNumber(total_pages) track by $index"><a  ng-click="changed_data($index);" href="">Bill {{$index+1}}</a></li>
