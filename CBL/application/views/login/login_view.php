...
<html>
  <head>
    ...
    <title>CBL | Log in</title>
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <!-- Bootstrap 3.3.5 -->
    <link rel="stylesheet" href="<?php echo base_url();?>assets/common/bootstrap/css/bootstrap.min.css">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?php echo base_url();?>assets/common/plugins/font-awesome-4.4.0/css/font-awesome.min.css">
    <!-- Ionicons -->
    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
          <div class="login-logo">
              <a style="color: white;" href="#"><img   height="80px" src="<?php echo base_url(); ?>assets/ico/1154494.png" class=""></a>
          </div><!-- /.login-logo -->
