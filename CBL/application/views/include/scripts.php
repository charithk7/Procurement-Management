...
<script src="<?php echo base_url(); ?>assets/admin/plugins/datatables/extensions/FileExport/buttons.html5.min.js"></script>
<script src="<?php echo base_url(); ?>assets/admin/plugins/datatables/extensions/FileExport/buttons.flash.min.js"></script>
<script src="<?php echo base_url(); ?>assets/admin/plugins/datatables/extensions/FileExport/jszip.min.js"></script>
<script src="<?php echo base_url(); ?>assets/admin/plugins/datatables/extensions/FileExport/pdfmake.min.js"></script>
<script src="<?php echo base_url(); ?>assets/admin/plugins/datatables/extensions/FileExport/vfs_fonts.js"></script>
...
<!--Custom Scripts-->
<script src="<?php echo base_url(); ?>assets/admin/js/custom.js?<?php echo $version; ?>"></script>
...
<script>
    ...
    var server_date_formatted='<?php echo date("Y/m/d")  ?>';
...
<!--Angular Module-->
<script src="<?php echo base_url(); ?>app/config.js?<?php echo $version; ?>"></script>

<!--Angular Controllers-->
<script src="<?php echo base_url(); ?>app/main.js?<?php echo $version; ?>"></script>
<script src="<?php echo base_url(); ?>app/search.js?<?php echo $version; ?>"></script>
<script src="<?php echo base_url(); ?>app/dashboard.js?<?php echo $version; ?>"></script>
<script src="<?php echo base_url(); ?>app/note_grn.js?<?php echo $version; ?>"></script>
<script src="<?php echo base_url(); ?>app/form/note_grn_add.js?<?php echo $version; ?>"></script>
<script src="<?php echo base_url(); ?>app/purchase_order.js?<?php echo $version; ?>"></script>
<script src="<?php echo base_url(); ?>app/form/purchase_order_add.js?<?php echo $version; ?>"></script>
<script src="<?php echo base_url(); ?>app/suppliers.js?<?php echo $version; ?>"></script>
<script src="<?php echo base_url(); ?>app/form/suppliers_add.js?<?php echo $version; ?>"></script>
<script src="<?php echo base_url(); ?>app/weigh_bridge.js?<?php echo $version; ?>"></script>


<!--Custom Application Functions-->
<script src="<?php echo base_url(); ?>app/custom_functions.js?<?php echo $version; ?>"></script>